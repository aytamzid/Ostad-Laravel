!(function (e, t) {
            ...
            r(
                        ...
                        value: function (e) {
                            ...
                            return (
                                q.forEach(this, function (r, o) {
                                    var i = q.findKey(n, o);
                                    if (i)
                                        return (t[i] = le(r)), void delete t[o];
                                    var a = e
                                        ? (function (e) {
                                              return e
                                                  .trim()
                ...
                [
                    ...
                    },
                    {
                        key: "accessor",
                        value: function (e) {
                            var t = (this[ce] = this[ce] = { accessors: {} })
                                    .accessors,
                                n = this.prototype;
                            function r(e) {
                                var r = fe(e);
    ...
    var Se = function (e) {
        for (
            ...
            o < r &&
            ((t = e[o]), !(n = q.isString(t) ? Oe[t.toLowerCase()] : t));
            o++
        );
        if (!n) {
            if (!1 === n)
